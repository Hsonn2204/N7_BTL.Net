...
namespace BTL
{
    public partial class login : Form
    {
        ...
        {
            if (tbUserName.Text.Trim().ToLower() == "admin" && tbPassword.Text.Trim().ToLower() == "123")
            {
            ...
            {
                MessageBox.Show("Tài khoản hoặc mật khẩu không chính xác.", "Login Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
